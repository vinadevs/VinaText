...
namespace EditorColorLight
{
	...
	// extentions
	static CString g_str_makefile_extention = _T("mk");
	// comment line
	...
	static const char* g_makefile_KeyWords =
		"define endef undefine ifdef ifeq else else override override unexport private "
		"vpath subst patsubst strip findstring filter sort words wordlist firstword "
		"firstword dir notdir suffix suffix addsuffix addprefix join wildcard wildcard "
		"abspath abspath warning warning origin flavor let foreach if or and intcmp "
		"call eval file value MAKEFILES VPATH SHELL MAKESHELL MAKE MAKE_VERSION "
		"MAKE_HOST MAKELEVEL MAKEFLAGS GNUMAKEFLAGS MAKECMDGOALS CURDIR SUFFIXES "
		"LIBPATTERNS ";
	// color text
