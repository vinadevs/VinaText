...
namespace AppUtils
{
	...
	std::string RemDuplicateWordInStdString(const std::string & str);
	std::string RemDuplicateMatchCaseWordInStdString(const std::string & str);
	...
	void ToInvertCase(std::string & str);
	void ToRandomCase(std::string & str);
