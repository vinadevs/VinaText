...
namespace VinaTextCompiler
{
	...
	// Html
	void BuildHTML(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Pascal
	void BuildPascal(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// C#
	void BuildCShape(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Assembly
	void BuildAssembly(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Batch
	void BuildBatch(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// C++
	void BuildPHP(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// VB
	void BuildVisualBasic(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// SQL
	void BuildSQL(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Powershell
	void BuildPowerShell(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Verilog
	void BuildVerilog(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Perl
	void BuildPerl(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Ruby
	void BuildRuby(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Go
	void BuildGo(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Tcl
	void BuildTCL(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// AutoIT
	void BuildAutoIT(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// Rust
	void BuildRust(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// R
	void BuildR(CMainFrame * pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
	// FreeBASIC
	void BuildFreeBasic(CMainFrame* pFrame, CEditorView* pView, const CString& strFilePath, const CString& strCompilerPath);
};
